...
<head>
	...
	<link rel="stylesheet" href="estilo/teste.css">
...
<body>
<?php require 'classe/usuarios.class.php';//inclusao do arquivo 
...
<form method="POST">
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" name="email"  a placeholder="Digite seu E-mail">
  ...
  <input style="margin-left: 100px;width: 150px;margin-top: 5px;" type="submit" name="acao"  class="btn btn-success" value="Cadastrar"><br><br>
 	<span style="margin-left: 70px;">Deseja realizar login? <a href="">  cliquei aqui</a></span>
</form>		
</div>
</div>
</body>
